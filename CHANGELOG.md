...
- [FIP-0010 off-chain Window PoSt Verification](https://github.com/filecoin-project/FIPs/blob/master/FIPS/fip-0010.md) which reduces the gas consumption of `SubmitedWindowedPost` messages significantly by optimistically accepting Window PoSt proofs without verification, and allowing them to be disputed later by off-chain verifiers.
...
- [#5433](https://github.com/filecoin-project/lotus/pull/5433) Added `AlwaysKeepUnsealedCopy` option to the miner configuration, default to true
...
- [#5500](https://github.com/filecoin-project/lotus/pull/5500) Code refactoring
- [#5404](https://github.com/filecoin-project/lotus/pull/5404) Added retrying proofs if an incorrect one is generated
- [#5512](https://github.com/filecoin-project/lotus/pull/5512) dagsplitter writes car files to disk
...
## Dependency Updates
 ...
 - [#5614](https://github.com/filecoin-project/lotus/pull/5614) Updated to [go-jsonrpc@v0.1.3](https://github.com/filecoin-project/go-jsonrpc/releases/tag/v0.1.3)
